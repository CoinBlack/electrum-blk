...
class TestWalletStorage(WalletTestCase):
    ...
    async def test_storage_imported_add_privkeys_persistence_test(self):
        text = ' '.join([
            'p2wpkh:PmEWvkYNN6vXoQt8mqB2tdJrFyJLeoV2fmPNtTHE3eDSMFs8PHri',
            'p2wpkh:PiZ3FpNbkDNc28rMvb8K5N74J1gr2dVRdQBbZegviYn4rd2D2X33'
        ])
        ...
        wallet.import_private_keys(['p2wpkh:PhQbscMJXqTArr4LkJkXqbztn7sxNW9USE9sh39oQPzKPxhuYC1N'], password=None)
    ...
    async def test_storage_prevouts_by_scripthash_persistence(self):
        ...
        self.assertEqual("BRpqWcEDJS5B5ffffsk584QiJZUroV1bMd", addr)
...
class TestCreateRestoreWallet(WalletTestCase):
    ...
    async def test_restore_wallet_from_text_mnemonic(self):
        ...
        self.assertEqual(encrypt_file, wallet.storage.is_encrypted())
        self.assertEqual('blk1q2ccr34wzep58d4239tl3x3734ttle92a97wzec', wallet.get_receiving_addresses()[0])
    ...
    async def test_restore_wallet_from_text_no_storage(self):
        ...
        self.assertEqual('blk1q3g5tmkmlvxryhh843v4dz026avatc0zzp56gcl', wallet.get_receiving_addresses()[0])
    ...
    async def test_restore_wallet_from_text_xkey_that_is_also_a_valid_electrum_seed_by_chance(self):
        ...
        self.assertEqual('bacKUME68gavzhwbnGC539AW1yv1Cg8J3e', wallet.get_receiving_addresses()[0])
    ...
    async def test_restore_wallet_from_text_addresses(self):
        text = 'blk1q2ccr34wzep58d4239tl3x3734ttle92a97wzec blk1qnp78h78vp92pwdwq5xvh8eprlga5q8guc5gr2w'
        d = restore_wallet_from_text__for_unittest(text, path=self.wallet_path, config=self.config)
        wallet = d['wallet']  # type: Imported_Wallet
        self.assertEqual('blk1q2ccr34wzep58d4239tl3x3734ttle92a97wzec', wallet.get_receiving_addresses()[0])
        self.assertEqual(2, len(wallet.get_receiving_addresses()))
        # also test addr deletion
        wallet.delete_address('blk1qnp78h78vp92pwdwq5xvh8eprlga5q8guc5gr2w')
        self.assertEqual(1, len(wallet.get_receiving_addresses()))

    async def test_restore_wallet_from_text_privkeys(self):
        text = 'p2wpkh:PmEWvkYNN6vXoQt8mqB2tdJrFyJLeoV2fmPNtTHE3eDSMFs8PHri p2wpkh:PiZ3FpNbkDNc28rMvb8K5N74J1gr2dVRdQBbZegviYn4rd2D2X33'
        d = restore_wallet_from_text__for_unittest(text, path=self.wallet_path, config=self.config)
        wallet = d['wallet']  # type: Imported_Wallet
        addr0 = wallet.get_receiving_addresses()[0]
        self.assertEqual('blk1q2ccr34wzep58d4239tl3x3734ttle92a97wzec', addr0)
...
class TestWalletPassword(WalletTestCase):
    ...
    async def test_update_password_of_imported_wallet(self):
SAYuj3ttiYVkfC2se":[],"BPHZr6yqa78pgSS3B6ZHsyxiteBTRXqHYF":[],"BRTBavtkPcgWWzXNQz8UHTkxNmvBsSdV1d":[],"BTDCuuACDook6EtVUG7mw94XagGHUJMPoR":[]},"addresses":{"change":["BL9rSfHdzbCjpX81mHdKh5wJ4Zq1bTrPXA","BKuJ4TChMfWV21fLsrpoaJAx2o4PA27TFp","B8hMX1NddPUvHy9NYdTtyjdLLenemnWmWo","BDVc4VNYASEJDmFHb7DqPsz2Fkzu46V5Vb","BDS8LjgYb7FwGFcHDTXB1Ayshvrhgu35QH","BMy44iCC4DT8uJxnSytG34CztjGF3sLqH5"],"receiving":["B88qofzgtdMtzmznuvd1Ub9GBtwEQhEbjw","B6jXdY7iNQTLyKk9rbRsg3JJ9Y3kAHatNL","BD2DkH7SQVoH33RtEz3ecDBq3ZHzmkLUu6","BMXY5BrXTTEbfzh6ho4rm92gkrwSPJjNqW","BTDCuuACDook6EtVUG7mw94XagGHUJMPoR","B7CLmDjM4M229ogn6pLqzUS3eg27aUmX1u","BNrNaLRF9ys4xBmV6NdhxLxH5vyCFhXSdk","B5gHJUSWrBsiM9eiiu3mvfzaUceG4rgvAX","B6AVfkhbLaw2KmYXEMB469ax4GGFvBtevo","B7ujfZAv2p7MLGxDwG3cuJVxPuGh5QVUZE","BPHZr6yqa78pgSS3B6ZHsyxiteBTRXqHYF","BBFPcf6MnCMzt4E2wAV83c1kYDtbZMwwaT","BHX4J9pWa1uwME1itg9rtbq1aZ13ccYizG","BC9TEABmjwCKpvnCD9aQ5wx9QRoP12aVS6","BPG3BP4E5PGiNZkPaSAYuj3ttiYVkfC2se","BCEDzyQPVGu6iY7DzgYCMyMYSdeTY6H5vj","B4erJy6DvsbbbaBosJddC3qpFyqJu2VZGq","BHMuKQjgLUuu3b86Lz4dCmhQWdbnbgwP8S","BKxvJXutvR2jVihqiPXmTYm4G1pNJsEQGs","BRTBavtkPcgWWzXNQz8UHTkxNmvBsSdV1d"]},"keystore":{"seed":"cereal wise two govern top pet frog nut rule sketch bundle logic","type":"bip32","xprv":"xprv9s21ZrQH143K29XjRjUs6MnDB9wXjXbJP2kG1fnRk8zjdDYWqVkQYUqaDtgZp5zPSrH5PZQJs8sU25HrUgT1WdgsPU8GbifKurtMYg37d4v","xpub":"xpub661MyMwAqRbcEdcCXm1sTViwjBn28zK9kFfrp4C3JUXiW1sfP34f6HA45B9yr7EH5XGzWuTfMTdqpt9XPrVQVUdgiYb5NW9m8ij1FSZgGBF"},"pruned_txo":{},"seed_type":"standard","seed_version":13,"stored_height":-1,"transactions":{},"tx_fees":{},"txi":{},"txo":{},"use_encryption":false,"verified_tx3":{},"wallet_type":"standard","winpos-qt":[619,310,840,405]}'''
        storage = WalletStorage(self.wallet_path)
        db = WalletDB(wallet_str, storage=storage, upgrade=True)
        wallet = Wallet(db, config=self.config)
