...
class TestConfig(QETestCase):
    ...
    def test_btc_amount_regexes(self):
        ...
        self.assertTrue(a.match('100000000').hasMatch())
        self.assertFalse(a.match('1000000000').hasMatch())
        ...
        self.assertTrue(b.match('100000000').hasMatch())
        self.assertFalse(b.match('1000000000').hasMatch())
        ...
        self.assertTrue(a.match('100000000000').hasMatch())
        self.assertFalse(a.match('1000000000000').hasMatch())
        ...
        self.assertTrue(b.match('1.00000000').hasMatch())
        self.assertFalse(b.match('1.000000000000').hasMatch())
        self.assertTrue(b.match('100000000000').hasMatch())
        self.assertFalse(b.match('1000000000000').hasMatch())
        ...
        self.assertTrue(a.match('10000000000000000').hasMatch())
        self.assertFalse(a.match('100000000000000000').hasMatch())

        self.assertTrue(b.match('1').hasMatch())
        self.assertTrue(b.match('1.').hasMatch())
        self.assertTrue(b.match('1.000').hasMatch())
        self.assertFalse(b.match('1.0000').hasMatch())
        self.assertTrue(b.match('10000000000000000').hasMatch())
        self.assertFalse(b.match('100000000000000000').hasMatch())
