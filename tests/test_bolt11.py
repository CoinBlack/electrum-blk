    ...
    def test_roundtrip(self):
        ...
        tests = [
            ...
            (BOLT11Addr(date=timestamp, paymenthash=RHASH, payment_secret=PAYMENT_SECRET, amount=24, tags=[
                ...
                ('f', 'B4szVcRdGYPV9tii9i9NPeiu4hTkusAPtF'),
                ('h', longdescription),
                ('9', 0x28200)]),
            ...
            (BOLT11Addr(date=timestamp, paymenthash=RHASH, payment_secret=PAYMENT_SECRET, amount=24, tags=[('f', 'bRo9YyFFurnFen4vKHg4WhE5u33KcBg8Tr'), ('h', longdescription), ('9', 0x28200)]),
            ...
            (BOLT11Addr(date=timestamp, paymenthash=RHASH, payment_secret=PAYMENT_SECRET, amount=24, tags=[('f', 'blk1qw508d6qejxtdg4y5r3zarvary0c5xw7kwfygwr'), ('h', longdescription), ('9', 0x28200)]),
            ...
            (BOLT11Addr(date=timestamp, paymenthash=RHASH, payment_secret=PAYMENT_SECRET, amount=24, tags=[('f', 'blk1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3qz65k06'), ('h', longdescription), ('9', 0x28200)]),
