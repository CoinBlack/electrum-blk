...
from electrum_blk.gui.qt.util import WaitingDialog, EnterButton, WindowModalDialog, read_QIcon
from electrum_blk.i18n import _
from electrum_blk.logging import get_logger

if TYPE_CHECKING:
    from electrum_blk.gui.qt.transaction_dialog import TxDialog
