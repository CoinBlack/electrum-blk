...
from electrum_blk.util import bfh, UserCancelled, UserFacingException
...
from electrum_blk.plugins.hw_wallet import HW_PluginBase
from electrum_blk.plugins.hw_wallet.plugin import is_any_tx_output_on_change_branch, \
