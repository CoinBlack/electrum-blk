...
from electrum_blk.plugins.hw_wallet import HW_PluginBase, HardwareClientBase
from electrum_blk.plugins.hw_wallet.plugin import OutdatedHwFirmwareException
