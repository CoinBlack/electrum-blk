...
from electrum_blk.wallet import Wallet, create_new_wallet
from electrum_blk.wallet_db import WalletDB
from electrum_blk.commands import Commands
from electrum_blk.util import create_and_start_event_loop, log_exceptions


loop, stopping_fut, loop_thread = create_and_start_event_loop()

config = SimpleConfig({"testnet": True})  # to use ~/.electrum-blk/testnet as datadir
