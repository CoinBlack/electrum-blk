...
from electrum_blk.util import bh2u, NetworkRetryManager, bfh, OldTaskGroup, EventListener
...
from electrum_blk.lnutil import derive_payment_secret_from_payment_preimage, UpdateAddHtlc
