...
from electrum_blk.util import is_subpath, ChoiceItem, multisig_type, UserCancelled, standardize_path
...
from electrum_blk.gui.qt.plugins_dialog import PluginsDialog
...
class WCWalletType(WalletWizardComponent):
    def __init__(self, parent, wizard):
        ...
        wallet_kinds = [
            ...
            ChoiceItem(key='imported', label=_('Import Blackcoin addresses or private keys')),
        ]
