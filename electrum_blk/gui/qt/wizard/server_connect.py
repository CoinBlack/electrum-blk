...
from electrum_blk.wizard import ServerConnectWizard
from electrum_blk.gui.qt.network_dialog import ProxyWidget, ServerWidget
from electrum_blk.gui.qt.util import icon_path
...
class WCWelcome(WizardComponent):
    def __init__(self, parent, wizard):
        ...
        self.wizard_title = _('Electrum Blackcoin Wallet')
