...
from electrum_blk._vendor.distutils.version import StrictVersion


class UpdateCheck(QDialog, Logger):
    url = "https://download.blackcoin.nl/electrum/version"
    download_url = "https://download.blackcoin.nl/electrum"
