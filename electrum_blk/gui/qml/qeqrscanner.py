...
from electrum_blk.util import send_exception_to_crash_reporter, UserFacingException
...
class QEQRScanner(QObject):
    ...
    def open(self):
        if 'ANDROID_DATA' not in os.environ:
            ...
            return
        SimpleScannerActivity = autoclass("org.electrum-blk.qr.SimpleScannerActivity")
