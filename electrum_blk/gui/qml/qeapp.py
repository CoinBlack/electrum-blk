...
from electrum_blk import version, constants
from electrum_blk.i18n import _
from electrum_blk.logging import Logger, get_logger
from electrum_blk.bip21 import BITCOIN_BIP21_URI_SCHEME, LIGHTNING_URI_SCHEME
...
class ElectrumQmlApplication(QGuiApplication):
    ...
    def __init__(self, args, *, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        qmlRegisterType(QEAmount, 'org.electrum-blk', 1, 0, 'Amount')
        qmlRegisterType(QENewWalletWizard, 'org.electrum-blk', 1, 0, 'QNewWalletWizard')
        qmlRegisterType(QEServerConnectWizard, 'org.electrum-blk', 1, 0, 'QServerConnectWizard')
        qmlRegisterType(QEFilterProxyModel, 'org.electrum-blk', 1, 0, 'FilterProxyModel')
        qmlRegisterType(QSortFilterProxyModel, 'org.electrum-blk', 1, 0, 'QSortFilterProxyModel')

        qmlRegisterType(QEWallet, 'org.electrum-blk', 1, 0, 'Wallet')
        qmlRegisterType(QEBitcoin, 'org.electrum-blk', 1, 0, 'Bitcoin')
        qmlRegisterType(QEQRParser, 'org.electrum-blk', 1, 0, 'QRParser')
        qmlRegisterType(QEQRScanner, 'org.electrum-blk', 1, 0, 'QRScanner')
        qmlRegisterType(QEFX, 'org.electrum-blk', 1, 0, 'FX')
        qmlRegisterType(QETxFinalizer, 'org.electrum-blk', 1, 0, 'TxFinalizer')
        qmlRegisterType(QEInvoice, 'org.electrum-blk', 1, 0, 'Invoice')
        qmlRegisterType(QEInvoiceParser, 'org.electrum-blk', 1, 0, 'InvoiceParser')
        qmlRegisterType(QEAddressDetails, 'org.electrum-blk', 1, 0, 'AddressDetails')
        qmlRegisterType(QETxDetails, 'org.electrum-blk', 1, 0, 'TxDetails')
        qmlRegisterType(QEChannelOpener, 'org.electrum-blk', 1, 0, 'ChannelOpener')
        qmlRegisterType(QELnPaymentDetails, 'org.electrum-blk', 1, 0, 'LnPaymentDetails')
        qmlRegisterType(QEChannelDetails, 'org.electrum-blk', 1, 0, 'ChannelDetails')
        qmlRegisterType(QESwapHelper, 'org.electrum-blk', 1, 0, 'SwapHelper')
        qmlRegisterType(QERequestDetails, 'org.electrum-blk', 1, 0, 'RequestDetails')
        qmlRegisterType(QETxRbfFeeBumper, 'org.electrum-blk', 1, 0, 'TxRbfFeeBumper')
        qmlRegisterType(QETxCpfpFeeBumper, 'org.electrum-blk', 1, 0, 'TxCpfpFeeBumper')
        qmlRegisterType(QETxCanceller, 'org.electrum-blk', 1, 0, 'TxCanceller')
        qmlRegisterType(QEBip39RecoveryListModel, 'org.electrum-blk', 1, 0, 'Bip39RecoveryListModel')

        # TODO QT6: these were declared as uncreatable, but that doesn't seem to work for pyqt6
        # qmlRegisterUncreatableType(QEAmount, 'org.electrum-blk', 1, 0, 'Amount', 'Amount can only be used as property')
        # qmlRegisterUncreatableType(QENewWalletWizard, 'org.electrum-blk', 1, 0, 'QNewWalletWizard', 'QNewWalletWizard can only be used as property')
        # qmlRegisterUncreatableType(QEServerConnectWizard, 'org.electrum-blk', 1, 0, 'QServerConnectWizard', 'QServerConnectWizard can only be used as property')
        # qmlRegisterUncreatableType(QEFilterProxyModel, 'org.electrum-blk', 1, 0, 'FilterProxyModel', 'FilterProxyModel can only be used as property')
        # qmlRegisterUncreatableType(QSortFilterProxyModel, 'org.electrum-blk', 1, 0, 'QSortFilterProxyModel', 'QSortFilterProxyModel can only be used as property')
