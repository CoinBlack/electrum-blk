...
if [ ! -z "$ELECBUILD_COMMIT" ] ; then
    ...
    FRESH_CLONE="/var/tmp/electrum_build/appimage/fresh_clone/electrum-blk"
...
docker run $DOCKER_RUN_FLAGS \
    ...
    -v "$PROJECT_ROOT_OR_FRESHCLONE_ROOT":/opt/electrum-blk \
    --rm \
    --workdir /opt/electrum-blk/contrib/build-linux/appimage \
