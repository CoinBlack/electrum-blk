...
if [ ! -z "$ELECBUILD_COMMIT" ] ; then
    ...
    FRESH_CLONE="/var/tmp/electrum_build/windows/fresh_clone/electrum-blk"
...
docker run $DOCKER_RUN_FLAGS \
    ...
    -v "$PROJECT_ROOT_OR_FRESHCLONE_ROOT":/opt/wine64/drive_c/electrum-blk \
    --rm \
    --workdir /opt/wine64/drive_c/electrum-blk/contrib/build-wine \
